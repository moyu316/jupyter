...
class RoIHeads(torch.nn.Module):
    ...
    def forward(self,
        ...
        box_features = self.box_head(box_features)     # [2048, 1208,7,7]->[2048, 1024]

        # 接着分别预测目标类别和边界框回归参数
        class_logits, box_regression = self.box_predictor(box_features)  # class_logits:[2048,21], box_regression:[2048,84]
