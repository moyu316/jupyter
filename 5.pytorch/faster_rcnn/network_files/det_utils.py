...
class BoxCoder(object):
    ...
    def decode(self, rel_codes, boxes):
        ...
        concat_boxes = torch.cat(boxes, dim=0)   # ([14250,4],[14250,4],[14250,4],[14250,4])->[57000,4]
        ...
        pred_boxes = self.decode_single(
            rel_codes, concat_boxes          # rel_codes:[57000,4](经过rpnhead生成的预测框回归参数)  concat_boxes:[57000,4](生成的anchor模板的坐标参数)
        )
    ...
    def decode_single(self, rel_codes, boxes):
        ...
        dw = torch.clamp(dw, max=self.bbox_xform_clip)  # 最大值大于4.135的等于4.135
        ...
        return pred_boxes     # pred_boxes[57000,4]
