...
file_path = '../pointer_detect/pointer_img/notebook.json'
img_path = '../pointer_detect/pointer_img/notebook.JPG'
...
# cv2.imwrite('11.jpg', bg)
# cv2.imwrite('13-1.jpg', draw_img)
