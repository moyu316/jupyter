...
class TextDataset(object):
    ...
    def get_training_data(self, image, polygons, transcripts, image_id, image_path):
        ...
        if self.transform:
            image, polygons = self.transform(image, copy.copy(polygons))  # [640,640,3]
