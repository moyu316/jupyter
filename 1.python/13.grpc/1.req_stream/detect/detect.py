...
class Classsification:
    def __init__(self, model_button_path, model_yaban_path):
        ...
        self.button_result = {}
        self.yaban_result = {}
        self.all_butoon_result = {}
        self.all_yaban_result = {}
    ...
    def button_classify(self, img, button_dict):
        ...
        self.all_butoon_result = {'旋钮': self.button_result}
        return self.all_butoon_result, img
    ...
    def yaban_classify(self, img, yaban_dict):
        ...
        self.all_yaban_result = {'压板': self.yaban_result}
        return self.all_yaban_result, img
            ...
            for monitor_name in monitor_dict:
                ...
                for detection in detections:
                    ...
                    if class_id == 1:  # 非绿灯
                        ...
                        self.monitor_result[small_light_name] = label
                    if class_id == 0:  # 绿灯
                        label = '绿'
                        img = draw_img(img, label, left_top, right_bottom)
                        small_light_name = judge_detect_name(left_top, right_bottom, small_light_dict)
                        self.monitor_result[small_light_name] = label
                if len(detections) != 0:
                    self.small_light_result['高压带电显示器'] = self.monitor_result
            ...
            for protection_name in protection_dict:
                ...
                for detection in detections:
                    ...
                    if class_id == 1:  # 非绿灯
                        ...
                        img = draw_img(img, label, left_top, right_bottom)
                        small_light_name = judge_detect_name(left_top, right_bottom, small_light_dict)
                        self.protection_result[small_light_name] = label
                    if class_id == 0:  # 绿灯
                        label = '绿'
                        img = draw_img(img, label, left_top, right_bottom)
                        small_light_name = judge_detect_name(left_top, right_bottom, small_light_dict)
                ...
                if len(detections) != 0:
                    self.small_light_result['保护装置'] = self.protection_result
            ...
            for binglie_name in binglie_dict:
                ...
                for detection in detections:
                    ...
                    if class_id == 1:  # 非绿灯
                        ...
                        img = draw_img(img, label, left_top, right_bottom)
                        small_light_name = judge_detect_name(left_top, right_bottom, small_light_dict)
                        self.binglie_result[small_light_name] = label
                    if class_id == 0:  # 绿灯
                        label = '绿'
                        img = draw_img(img, label, left_top, right_bottom)
                        small_light_name = judge_detect_name(left_top, right_bottom, small_light_dict)
                ...
                if len(detections) != 0:
                    self.small_light_result['并列装置'] = self.binglie_result
