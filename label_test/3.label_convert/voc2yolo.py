...
def parseXmlFilse(voc_dir, save_dir):
    ...
    for xml_file in xml_files:
        with open(xml_file, encoding="utf-8") as fid:
            xml_str = fid.read()
        xml = etree.fromstring(xml_str)
        info_dict = parse_xml_to_dict(xml)
...
if __name__ == '__main__':
    voc_dir = r'F:\PythonWork\dataset\electrical_cabinet_all\detect\traffic_light\voc\Annotations'
    save_dir = r'F:\PythonWork\dataset\electrical_cabinet_all\detect\traffic_light\voc\yolo'
