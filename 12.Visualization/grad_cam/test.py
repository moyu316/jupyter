...
def myimshows(imgs, titles=False, fname="test1.jpg", size=6):
    lens = len(imgs)
...
# 加载模型
model_button_path = r'F:\PythonWork\5.classification\1.resnet\weight\best\resNet18_button2_200.pth'
...
# 加载变量并进行预测
path = r"F:\PythonWork\dataset\electrical_cabinet_all\classify\button1\train\right_top/right_top-16_n.jpg"
img = cv2.imread(path)
print(img.shape)
